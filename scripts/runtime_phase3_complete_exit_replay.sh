...
run_replay() {
  local replay_case=$1 expected_marker=$2 output status=0
...
run_replay phase3_complete_exit_save "RUNTIME_REPLAY phase3_complete_exit_save PASS"
...
echo "RUNTIME_REPLAY phase3_complete_exit PASS title=true oak=true identity=RED/GREEN bedroom=true pallet=true route1=true wild=playerLost money=2960 hp=recovered saved=true reload=true party=1"
