...
| Wild encounters and capture persistence | FireRed encounter tables and party/PC routing rules | `tests/wild_*_test.lua`, `tests/capture_rewards_test.lua` | Wild battle and catch path wired; PC overflow remains incomplete |
