...
local EFFECT_HANDLERS = {
  ...
  [46] = alwaysNoPenalty,                          -- EFFECT_MIST: engine modeled; AI condition still open
  [47] = alwaysNoPenalty,                          -- EFFECT_FOCUS_ENERGY: engine modeled; AI condition still open
  ...
  [136] = alwaysNoPenalty,                         -- EFFECT_RAIN_DANCE: engine modeled; AI condition still open
  [137] = alwaysNoPenalty,                         -- EFFECT_SUNNY_DAY: engine modeled; AI condition still open
