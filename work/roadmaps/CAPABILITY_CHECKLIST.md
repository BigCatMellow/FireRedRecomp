...
| Phase 3 — playable vertical slice | IN PROGRESS | New game, movement, wild battle, capture, save/load tests | One repeatable end-to-end proof: boot → new game → Route 1 → battle → catch/defeat → save → reload |
