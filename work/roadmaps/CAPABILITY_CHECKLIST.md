...
| --- | --- | --- | --- |
| Phase 0 — charter and reproducibility | IN PROGRESS | `PARITY_CONTRACT.md`, `docs/behavior-ledger.md`, existing no-ROM CI; [first/current public receipts independently verified](../reviews/2026-09-20-ci-proof-discovery-review.md) | Save-contract review, CI syntax/docs enforcement and clean-clone proof remain; behavior ledger needs rows as subsystems grow |
