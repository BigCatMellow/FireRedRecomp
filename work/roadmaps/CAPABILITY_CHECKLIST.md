...
1. Complete the explicit Local Worker Bridge route prerequisite, then prove
   the Phase 3 exit path with one deterministic, ROM-backed continuous replay;
   see [`work/tasks/local-worker-bridge-complete-runtime-route.md`](../tasks/local-worker-bridge-complete-runtime-route.md)
   and [`work/tasks/phase3-complete-runtime-exit-replay.md`](../tasks/phase3-complete-runtime-exit-replay.md).
