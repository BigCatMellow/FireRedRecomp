...
| Phase 3 — playable vertical slice | IN PROGRESS | New game, movement, wild battle, capture, save/load tests; ROM-gated `tests/phase3_exit_path_rom_test.lua` composition replay; `scripts/runtime_replay_smoke.sh` proves live boot/input/house-to-Pallet warps | Normal new-game controls, Pallet-to-Route-1 traversal, live wild-battle outcome, and two-process disk save/load replay |
