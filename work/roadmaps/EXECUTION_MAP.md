...
| Phase 4H — high-critical effect discovery | `ACTIVE` | **[`../tasks/phase4-high-critical-effect-discovery.md`](../tasks/phase4-high-critical-effect-discovery.md)** | source-locked effect-43 crit-stage semantics and ROM inventory | bounded next effect decision |
