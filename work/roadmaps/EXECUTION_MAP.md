...
| Phase 4Q — terminal outcome/replacement-policy discovery | `READY FOR INDEPENDENT REVIEW` | **[`../tasks/phase4-terminal-outcome-replacement-policy-discovery.md`](../tasks/phase4-terminal-outcome-replacement-policy-discovery.md)** | source-lock `DREW`, local player→foe replacement ordering, and project API gap | two-sided state/API migration design after PASS |
