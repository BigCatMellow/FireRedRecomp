...
| Phase 4AB-pre — bridge route for Psywave | `REVIEWED PASS` | [`../tasks/local-worker-bridge-phase4-psywave-route.md`](../tasks/local-worker-bridge-phase4-psywave-route.md) | literal selector/allowlist/test/replay/staging route independently passed; separate probe still required | configure literal route |
