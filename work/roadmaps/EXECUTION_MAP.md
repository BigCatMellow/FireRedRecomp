...
| Phase 4AF — Endeavor effect | `READY FOR ONE REVIEWED WORKER REQUEST` | [`../tasks/phase4-endeavor-effects.md`](../tasks/phase4-endeavor-effects.md) | amended route/probe, corrected contract, and v3 generic-failure artifact independently passed | submit only reviewed v3 request |
