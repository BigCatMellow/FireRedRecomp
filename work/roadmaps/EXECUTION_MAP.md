...
| Phase 4J — False Swipe effect discovery | `DISCOVERY COMPLETE — PENDING INDEPENDENT REVIEW` | **[`../tasks/phase4-false-swipe-effect-discovery.md`](../tasks/phase4-false-swipe-effect-discovery.md)** | #206 effect-101 ordinary-Hit post-formula lethal cap to target HP minus one | effect-101 route decision |
