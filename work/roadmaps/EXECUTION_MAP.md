...
| Phase 4P — ordered replacement-state design | `PENDING INDEPENDENT REVIEW` | **[`../tasks/phase4-ordered-replacement-state-design.md`](../tasks/phase4-ordered-replacement-state-design.md)** | post-faint two-phase state contract; terminal outcome/replacement policy remains source-lock prerequisite | outcome/policy discovery after PASS |
