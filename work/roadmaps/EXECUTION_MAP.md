...
| Phase 4AF-pre — bridge route for Endeavor | `REVIEWED PASS / CONFIG REVIEWED PASS` | [`../tasks/local-worker-bridge-phase4-endeavor-route.md`](../tasks/local-worker-bridge-phase4-endeavor-route.md) | generic move-failure event requires minimal scene/controller-test expansion; amendment/configuration passed and original probe `b3090013` is superseded | run fresh probe only |
| Phase 4AF — Endeavor effect | `PAUSED FOR ROUTE AMENDMENT` | [`../tasks/phase4-endeavor-effects.md`](../tasks/phase4-endeavor-effects.md) | candidate review rejected screen-only failure-event reuse | no Worker request until amended route passes |
