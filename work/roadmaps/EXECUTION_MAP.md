...
| Phase 4C-pre — bridge route for player forced replacement | `ACTIVE` | **[`../tasks/local-worker-bridge-phase4-player-forced-replacement-route.md`](../tasks/local-worker-bridge-phase4-player-forced-replacement-route.md)** | explicit route + probe + independent PASS | Phase 4C eligibility |
| Phase 4C — player forced replacement UI | `BLOCKED ON BRIDGE ROUTE` | [`../tasks/phase4-player-forced-replacement-ui.md`](../tasks/phase4-player-forced-replacement-ui.md) | trainer-only forced PARTY state and save/live-state proof | broader player switching |
