...
| Phase 4AF-pre — bridge route for Endeavor | `REVIEWED PASS / CONFIG REVIEWED PASS` | [`../tasks/local-worker-bridge-phase4-endeavor-route.md`](../tasks/local-worker-bridge-phase4-endeavor-route.md) | literal effect-189 allowlist, tests, replay, and exclusion contract; configuration independently passed | run separate probe only |
