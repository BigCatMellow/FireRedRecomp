...
| Phase 4AI-pre — bridge route for Pain Split | `REVIEWED PASS / CONFIG REVIEWED PASS` | [`../tasks/local-worker-bridge-phase4-pain-split-route.md`](../tasks/local-worker-bridge-phase4-pain-split-route.md) | literal effect-91 allowlist, tests, replay, and HP-order contract; configuration independently passed | run separate probe only |
