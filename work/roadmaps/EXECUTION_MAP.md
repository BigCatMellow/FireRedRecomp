...
| Phase 4Z-pre — bridge route for Eruption/Water Spout | `READY FOR INDEPENDENT REVIEW` | **[`../tasks/local-worker-bridge-phase4-eruption-route.md`](../tasks/local-worker-bridge-phase4-eruption-route.md)** | exact effect-190 Worker route plan; no config or implementation authorized | independent route-plan review |
