...
| Phase 4E-pre — bridge route for fixed-damage effects | `ACTIVE` | **[`../tasks/local-worker-bridge-phase4-fixed-damage-effects-route.md`](../tasks/local-worker-bridge-phase4-fixed-damage-effects-route.md)** | explicit route + probe + independent PASS | Phase 4E eligibility |
| Phase 4E — fixed-damage effects | `BLOCKED ON BRIDGE ROUTE` | [`../tasks/phase4-fixed-damage-effects.md`](../tasks/phase4-fixed-damage-effects.md) | Dragon Rage/level/SonicBoom source and engine proof | next effect/admission matrix |
