...
| Phase 2B — Oak/reference visual-evidence harness | `ACTIVE` | **[`../tasks/phase2-oak-reference-evidence-harness.md`](../tasks/phase2-oak-reference-evidence-harness.md)** | deterministic 240×160 implementation captures and external-reference protocol | reference comparison task |
