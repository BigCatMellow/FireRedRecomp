...
| Phase 4R — two-sided replacement-state/API migration design | `READY FOR INDEPENDENT REVIEW` | **[`../tasks/phase4-two-sided-replacement-state-api-design.md`](../tasks/phase4-two-sided-replacement-state-api-design.md)** | queue-compatible state contract, draw settlement, controller/persistence handoff, and test matrix | state/API bridge route after PASS |
