...
| Phase 4P — ordered replacement-state design | `ACTIVE` | **[`../tasks/phase4-ordered-replacement-state-design.md`](../tasks/phase4-ordered-replacement-state-design.md)** | source-backed post-faint pending-side/outcome contract | effect-7 route decision after PASS |
