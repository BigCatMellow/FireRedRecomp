...
| Phase 4U — Super Fang effect discovery | `READY FOR INDEPENDENT REVIEW` | **[`../tasks/phase4-super-fang-effect-discovery.md`](../tasks/phase4-super-fang-effect-discovery.md)** | source-locked effect-40 current-HP-halving candidate; no implementation authorized | independent discovery review, then route plan only if PASS |
