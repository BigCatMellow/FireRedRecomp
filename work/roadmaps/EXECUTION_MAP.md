...
| Phase 4C — player forced replacement UI | `NOT STARTED` | [`../tasks/phase4-player-forced-replacement-ui.md`](../tasks/phase4-player-forced-replacement-ui.md) | bounded interface/acceptance discovery | live player replacement |
