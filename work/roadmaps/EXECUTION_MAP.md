...
| Phase 4M-pre — bridge route for Vital Throw | `ACTIVE` | **[`../tasks/phase4-vital-throw-effects.md`](../tasks/phase4-vital-throw-effects.md)** | exact fail-closed seven-surface route + one-file probe + independent PASS | Phase 4M eligibility |
| Phase 4M — Vital Throw effect | `BLOCKED ON ROUTE` | [`../tasks/phase4-vital-throw-effects.md`](../tasks/phase4-vital-throw-effects.md) | effect-78 no-roll accuracy/RNG proof with existing priority -1 | next admission-matrix leaf |
