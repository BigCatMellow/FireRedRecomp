...
| Phase 4AD — OHKO effects | `READY FOR WORKER` | **[`../tasks/phase4-ohko-effects.md`](../tasks/phase4-ohko-effects.md)** | reviewed/probed route; source-locked effect-38 request | independently reviewed Worker request |
