...
| Phase 4AD-pre — bridge route for OHKO | `PENDING INDEPENDENT REVIEW` | **[`../tasks/local-worker-bridge-phase4-ohko-route.md`](../tasks/local-worker-bridge-phase4-ohko-route.md)** | literal selector/allowlist/test/replay/staging route and separate probe | Phase 4AD implementation eligibility |
