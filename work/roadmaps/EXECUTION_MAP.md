...
| Phase 2A-fix — camera bridge optional staging | `ACTIVE` | **[`../tasks/local-worker-bridge-phase2-camera-optional-staging-fix.md`](../tasks/local-worker-bridge-phase2-camera-optional-staging-fix.md)** | exact optional-document staging correction + independent PASS | guarded camera publication retry |
| Phase 2A — true 240×160 overworld camera viewport | `REVIEWED LOCALLY` | [`../tasks/phase2-gba-camera-viewport-proof.md`](../tasks/phase2-gba-camera-viewport-proof.md) | local PASS at `ab8bdc71`; guarded run `34753075794` passed all evidence gates but not final staging | re-evaluate remaining Phase 2 visual parity gate after publication |
