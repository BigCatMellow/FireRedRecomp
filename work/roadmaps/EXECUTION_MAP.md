...
| Phase 4S — two-sided replacement-state/API migration | `READY FOR WORKER` | **[`../tasks/phase4-two-sided-replacement-state-api.md`](../tasks/phase4-two-sided-replacement-state-api.md)** | guarded patch: queue/state, draw settlement, controller/persistence, focused/full/ROM/replay evidence | independent review, then separate Explosion scope |
