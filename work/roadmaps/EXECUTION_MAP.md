...
| Phase 4AB — Psywave effect | `READY FOR WORKER` | **[`../tasks/phase4-psywave-effects.md`](../tasks/phase4-psywave-effects.md)** | reviewed/probed route; source-locked effect-88 request | independently reviewed Worker request |
