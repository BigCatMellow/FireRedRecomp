...
| Phase 2B-pre — Local Worker Bridge route for Oak/reference evidence | `ACTIVE` | **[`../tasks/local-worker-bridge-phase2-oak-reference-evidence-route.md`](../tasks/local-worker-bridge-phase2-oak-reference-evidence-route.md)** | explicit fail-closed evidence route + probe + independent PASS | Phase 2B harness eligibility |
| Phase 2B — Oak/reference visual-evidence harness | `BLOCKED ON BRIDGE ROUTE` | [`../tasks/phase2-oak-reference-evidence-harness.md`](../tasks/phase2-oak-reference-evidence-harness.md) | deterministic 240×160 implementation captures and external-reference protocol | reference comparison task |
