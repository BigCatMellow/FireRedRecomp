...
| Phase 4Z — Eruption/Water Spout effects | `READY FOR WORKER` | **[`../tasks/phase4-eruption-effects.md`](../tasks/phase4-eruption-effects.md)** | config PASS `09b25096`; probe `104e7eaf`, guarded run `34996725283` | independently reviewed Worker request |
