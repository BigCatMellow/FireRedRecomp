...
| Phase 4F — move admission-matrix discovery | `ACTIVE` | **[`../tasks/phase4-move-admission-matrix-discovery.md`](../tasks/phase4-move-admission-matrix-discovery.md)** | source-backed inventory of positive-power effect families currently admitted vs actually represented | bounded next effect-family decision |
