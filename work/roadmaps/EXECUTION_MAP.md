...
| Phase 4AD-pre — bridge route for OHKO | `REVIEWED PASS` | [`../tasks/local-worker-bridge-phase4-ohko-route.md`](../tasks/local-worker-bridge-phase4-ohko-route.md) | literal selector/allowlist/test/replay/staging route independently passed; separate probe still required | configure literal route |
