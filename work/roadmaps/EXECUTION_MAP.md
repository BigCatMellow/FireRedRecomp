...
| Phase 4D-pre — bridge route for voluntary player switch | `ACTIVE` | **[`../tasks/local-worker-bridge-phase4-player-voluntary-switch-route.md`](../tasks/local-worker-bridge-phase4-player-voluntary-switch-route.md)** | explicit route + probe + independent PASS | Phase 4D eligibility |
| Phase 4D — trainer-only voluntary player switching | `BLOCKED ON BRIDGE ROUTE` | [`../tasks/phase4-player-voluntary-switch.md`](../tasks/phase4-player-voluntary-switch.md) | normal-turn switch ordering + save/UI proof | trainer held-item/effect matrix |
