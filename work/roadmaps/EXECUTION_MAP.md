...
| Phase 4AB-pre — bridge route for Psywave | `CONFIGURED — REVIEWED PASS` | [`../tasks/local-worker-bridge-phase4-psywave-route.md`](../tasks/local-worker-bridge-phase4-psywave-route.md) | literal selector/allowlist/test/replay/staging configuration independently passed; separate probe still required | run separate probe |
