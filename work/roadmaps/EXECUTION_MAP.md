...
| Phase 4T — Explosion effect | `READY FOR WORKER` | **[`../tasks/phase4-explosion-effects.md`](../tasks/phase4-explosion-effects.md)** | guarded effect-7 patch: Damp/self-KO/defense/RNG/faint order, focused/full/ROM/replay evidence | independent review, then next effect discovery |
