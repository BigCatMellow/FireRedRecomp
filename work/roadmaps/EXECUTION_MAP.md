...
| Phase 4X — Flail/Reversal effects | `READY FOR WORKER` | **[`../tasks/phase4-flail-effects.md`](../tasks/phase4-flail-effects.md)** | config PASS `d0e151e2`; probe `883536b0`, guarded run `34994516318` | independently reviewed Worker request |
