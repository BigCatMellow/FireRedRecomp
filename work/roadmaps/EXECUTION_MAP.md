...
| Phase 4AB-pre — bridge route for Psywave | `PENDING INDEPENDENT REVIEW` | **[`../tasks/local-worker-bridge-phase4-psywave-route.md`](../tasks/local-worker-bridge-phase4-psywave-route.md)** | literal selector/allowlist/test/replay/staging route and separate probe | Phase 4AB implementation eligibility |
