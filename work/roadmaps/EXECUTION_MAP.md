...
| Phase 4AC — OHKO effect discovery | `PENDING INDEPENDENT REVIEW` | **[`../tasks/phase4-ohko-effect-discovery.md`](../tasks/phase4-ohko-effect-discovery.md)** | four exact records, special level/RNG KO contract, and explicit unrepresented-state exclusions | separate fail-closed route only if reviewed PASS |
