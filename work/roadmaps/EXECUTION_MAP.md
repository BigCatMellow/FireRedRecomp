...
| Phase 4AI — Pain Split effect | `PENDING INDEPENDENT IMPLEMENTATION-SCOPE REVIEW` | **[`../tasks/phase4-pain-split-effect.md`](../tasks/phase4-pain-split-effect.md)** | literal effect-91 admission and two-sided HP contract | one Worker request only if reviewed PASS |
