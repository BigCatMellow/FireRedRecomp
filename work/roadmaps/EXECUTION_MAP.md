...
| Phase 4T-pre — bridge route for Explosion | `READY FOR INDEPENDENT REVIEW` | **[`../tasks/local-worker-bridge-phase4-explosion-route.md`](../tasks/local-worker-bridge-phase4-explosion-route.md)** | exact effect-7-only allowlist, focused/full/replay commands, staging list, and separate probe | Phase 4T route configuration after PASS |
