...
| Phase 2A-fix — camera bridge integration-test route | `ACTIVE` | **[`../tasks/local-worker-bridge-phase2-camera-integration-test-route.md`](../tasks/local-worker-bridge-phase2-camera-integration-test-route.md)** | exact second focused-test allowlist/command/staging correction + independent PASS | guarded camera publication |
| Phase 2A — true 240×160 overworld camera viewport | `READY FOR WORKER` | [`../tasks/phase2-gba-camera-viewport-proof.md`](../tasks/phase2-gba-camera-viewport-proof.md) | independently passed local evidence at `ab8bdc71`; pending guarded publication after Phase 2A-fix | re-evaluate remaining Phase 2 visual parity gate |
