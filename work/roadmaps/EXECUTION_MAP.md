...
| Phase 4Y — Eruption/Water Spout effect discovery | `READY FOR INDEPENDENT REVIEW` | **[`../tasks/phase4-eruption-effect-discovery.md`](../tasks/phase4-eruption-effect-discovery.md)** | effect-190 current-HP dynamic-power source lock; no implementation authorized | independent discovery review |
