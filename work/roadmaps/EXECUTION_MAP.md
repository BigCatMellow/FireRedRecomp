...
Phase 2 renderer/runtime [IN PROGRESS]  ← EXTERNAL REFERENCE BLOCKER
        ...
        └─ Oak/reference screenshot discrepancy gate: remains after camera viewport PASS
                          ↓
Phase 4 battle generalization [IN PROGRESS]  ← CURRENT ACTIVE PACKAGE: Pain Split fixture-review gate
        ↓
...
| Phase 4AI — Pain Split effect | `REVIEWED_NEEDS_FIX` | **[`../tasks/phase4-pain-split-effect.md`](../tasks/phase4-pain-split-effect.md)** | Existing one Worker request failed before publication only because its #220 flags fixture expected `51`; verified ROM data is `18` | independent smallest fixture-correction review; see [`TASK_REGISTER.md`](../coordination/TASK_REGISTER.md) |
