...
| Phase 4AA — Psywave effect discovery | `PENDING INDEPENDENT REVIEW` | **[`../tasks/phase4-psywave-effect-discovery.md`](../tasks/phase4-psywave-effect-discovery.md)** | exact effect-88 record, rejection-sampling formula/RNG order, and dependency classification | separate fail-closed route only if reviewed PASS |
