...
| Phase 4AF-pre — bridge route for Endeavor | `REVIEWED PASS / PROBE PASS` | [`../tasks/local-worker-bridge-phase4-endeavor-route.md`](../tasks/local-worker-bridge-phase4-endeavor-route.md) | configuration independently passed; probe `b3090013`, guarded run `35081185726` | Phase 4AF implementation-scope review |
| Phase 4AF — Endeavor effect | `ACTIVE — REVIEWED IMPLEMENTATION CONTRACT` | [`../tasks/phase4-endeavor-effects.md`](../tasks/phase4-endeavor-effects.md) | effect-189 contract is limited to viability-before-accuracy and stored HP delta; independently reviewed | one literal Worker request through reviewed/probed route |
