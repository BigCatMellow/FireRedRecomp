...
| Phase 4AD-pre — bridge route for OHKO | `CONFIGURED — REVIEWED PASS` | [`../tasks/local-worker-bridge-phase4-ohko-route.md`](../tasks/local-worker-bridge-phase4-ohko-route.md) | literal selector/allowlist/test/replay/staging configuration independently passed; separate probe still required | run separate probe |
