...
| Phase 4G-pre — bridge route for always-hit effects | `ACTIVE` | **[`../tasks/phase4-always-hit-effects.md`](../tasks/phase4-always-hit-effects.md)** | exact fail-closed seven-surface route, one-file probe, and independent PASS | Phase 4G eligibility |
| Phase 4G — always-hit effects | `BLOCKED ON ROUTE` | [`../tasks/phase4-always-hit-effects.md`](../tasks/phase4-always-hit-effects.md) | source-locked no-accuracy-RNG behavior for all six effect-17 ROM records, focused/full/replay/review evidence | next admission-matrix leaf |
