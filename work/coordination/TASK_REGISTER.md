...
| `P4-02-ROUTE` | `READY_FOR_WORKER` | `WORKER` | Configuration `24f39c424347425be9836e16d529c7706641aa93`; [independent configuration PASS](../reviews/2026-09-20-move-effect-inventory-route-review.md) | Syntax/selector/allowlist/staging and old-workflow preservation independently verified; one separate probe now authorized. | Publish only `phase4-move-effect-inventory-route-20260920.probe`; return guarded run; no inventory request yet. |
