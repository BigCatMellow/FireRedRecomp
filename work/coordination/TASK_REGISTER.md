...
| `P4-02-ROUTE` | `READY_FOR_WORKER` | `WORKER` | [Route contract](../tasks/local-worker-bridge-phase4-move-effect-inventory-route.md); [readiness PASS](../reviews/2026-09-20-move-effect-inventory-readiness-review.md) | New literal selector, three-file allowlist, explicit no-replay branch; no existing route changes. | Exact configuration to Reviewer, then separate probe; unlock `P4-02` request. |
