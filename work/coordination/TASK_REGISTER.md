...
| `P0-SAVE-ROLLOVER` | `READY_FOR_WORKER` | `WORKER` | [Source-locked counter task](../tasks/phase0-save-counter-rollover.md) | Seven allowed paths; u32 increment and literal maximum/zero selection only; suffix/filesystem policy unchanged. | Boundary regression, focused/full tests, exact independent review. |
...
| `P0-03-CHECKS` | `READY_FOR_REVIEWER` | `REVIEWER` | [Public repository-check task](../tasks/phase0-ci-repository-checks.md), exact `3478822` | Worker 47/0, 275 Lua/144 Markdown/166 targets, exact-tree 150-file suite PASS; published public receipt pending. | Verify exact public check/suite run and implementation; do not close from local evidence alone. |
