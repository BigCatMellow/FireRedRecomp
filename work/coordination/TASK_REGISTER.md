...
| `P4-02-ROUTE` | `READY_FOR_REVIEWER` | `REVIEWER` | Configuration `24f39c424347425be9836e16d529c7706641aa93`; [route contract](../tasks/local-worker-bridge-phase4-move-effect-inventory-route.md) | Three allowed files; five new workflow cases; before/after 149-file baseline, YAML/shell syntax, selector/allowlist negatives, and old-workflow preservation checks PASS. | Independent exact configuration review, then separately authorized probe; no request yet. |
| `P4-02` | `READY_FOR_WORKER` | `RESEARCHER / WORKER` | [Inventory contract](../tasks/phase4-move-effect-inventory.md); same readiness PASS | Preparation only in isolated worktree; no request publication until route review/probe PASS; full SHA-ROM execution required. | Independent report/test review, then one selected source-lock discovery. |
